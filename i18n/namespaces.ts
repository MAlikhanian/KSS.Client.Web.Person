...
// Re-run:  .\sync-kit.ps1 -Project Person
//
...
import faPersonEditGuide from '@/i18n/person-edit-guide/fa.json';
import enPersonEditGuide from '@/i18n/person-edit-guide/en.json';
...
import faPersonSecurity from '@/i18n/person-security/fa.json';
import enPersonSecurity from '@/i18n/person-security/en.json';
...
export const DOMAIN_NAMESPACES = {
  ...
  'person-edit-guide': faPersonEditGuide,
  ...
  'person-security': faPersonSecurity,
  ...
  'person-edit-guide': enPersonEditGuide,
  ...
  'person-security': enPersonSecurity,
